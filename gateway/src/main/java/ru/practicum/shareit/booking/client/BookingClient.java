...
public class BookingClient extends BaseClient {
    ...
    public ResponseEntity<Object> postBooking(long userId, BookingDtoFromUser bookingDtoFromUser) {
    ...
    public ResponseEntity<Object> getAllBookingsForUserItems(long userId, String state, Integer from, Integer size) {
        Map<String, Object> parameters = Map.of(
                "state", state,
                "from", from,
                "size", size
